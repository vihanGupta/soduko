...
if(take7 !== document.getElementById("twentyone").innerHTML && take8 !== document.getElementById("twentyone").innerHTML && take9 !== document.getElementById("twentyone").innerHTML)
{
    answer2 = document.getElementById("twentyone").innerHTML;
    console.log(answer2);
}
if(take7 !== document.getElementById("thirtyone").innerHTML && take8 !== document.getElementById("thirtyone").innerHTML && take9 !== document.getElementById("thirtyone").innerHTML)
{
    answer2 = document.getElementById("thirtyone").innerHTML;
    console.log(answer2);
}if(take7 !== document.getElementById("thirtythree").innerHTML && take8 !== document.getElementById("thirtythree").innerHTML && take9 !== document.getElementById("thirtythree").innerHTML)
{
    answer2 = document.getElementById("thirtythree").innerHTML;
    console.log(answer2);
}
